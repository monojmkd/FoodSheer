...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center mx-6 lg:mx-28 py-5 pl-6 lg:pl-10 bg-black shadow-md rounded-b-3xl">
      <div>
        <a className="text-2xl lg:text-6xl font-bold text-white font-cookie">
      ...
      <ul
        ...
        } lg:flex lg:w-1/2 list-none font-sans absolute lg:static top-16 left-0 lg:top-0 bg-black lg:bg-transparent w-full lg:w-auto p-5 lg:p-0`}
      >
        <li className="ml-4 lg:ml-8 my-4 lg:my-0 rounded-2xl hover:bg-orange-300 h-11 flex justify-center items-center">
          <Link
